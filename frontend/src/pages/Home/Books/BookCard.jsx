    ...
    <div className='flex flex-col sm:flex-row items-center sm:h-74 justify-center gap-4 '>
     ...
     {/* right side of card */}
      <div className='sm:h-74 flex flex-col justify-between'>
        ...
        <button onClick={()=> handleAddToCart(book)} className='btn bg-[#FFCE1A] flex gap-2 items-center px-2 sm:px-6 mb-5 hover:bg-blue-700 hover:text-white transition-all duration-300 w-40'><FiShoppingCart className='size-5'/> <h1 className='text-sm'>Add to Cart</h1></button>
      </div>
    </div>
    </section>
  )
